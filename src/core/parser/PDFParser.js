...
import { MissingKeywordError, MissingPDFHeaderError, PDFInvalidObjectParsingError, ReparseError, StalledParserError, } from '@/core/errors';
...
Object.defineProperty(PDFParser, "forBytesWithOptions", {
    ...
    configurable: true,
    writable: true,
    value: (pdfBytes, objectsPerTick, throwOnInvalidObject, capNumbers) => new PDFParser(pdfBytes, objectsPerTick, throwOnInvalidObject, capNumbers)
});
